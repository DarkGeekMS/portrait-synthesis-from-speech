...
def face_alignment(img, scale=0.9, face_size=(1024,1024)):
    '''
...
def _crop_face(img, face_loc, padding_size=0):
    ...
    '''
    h, w, c = img.shape
    four_paddings = [face_loc[0]-3, h-3-face_loc[2], w-3-face_loc[1], face_loc[3]-3]
    padding_size = min(four_paddings) + 300
